...
const EvaluationTab = ({ value, evalTab, setEvaluationTab }) => {
  ...
  const handleChange = (e) => { //kinuha ko lang sa code ng registerCard
  ...
  return (
    <form ref={formRef} onSubmit={handleSubmit}>
      <div
        className={`absolute h-screen w-screen bg-[#000000a2] z-30 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 ${evalTab}`}
      >
            ...
            <table className="table-auto h-[15%] w-[93%] bg-[#d6d6d6] mt-3 rounded-lg overflow-hidden">
              ...
              <tbody>
                <tr className="text-center h-[46%] text-[10px] sm:text-xs">
                  ...
                  <td>
                    <h3 className="border-r border-gray-700">{value.inventory_id}</h3>
                  </td>
                  <td>
                    <h3 className="border-r border-gray-700">{value.cap ? "Yes" : "No"}</h3>
                  </td>
                  <td>
                    <h3 className="border-r border-gray-700">{value.tassel_color}</h3>
                  </td>
                  <td>
                    <h3 className="border-r border-gray-700">{value.hood_color}</h3>
                  </td>
                  <td>
                    <h3 className="border-r border-gray-700">{value.toga_size}</h3>
                  </td>
                  ...
                  >
                    ...
                    <td>
                      <div className="flex justify-center items-center">
                        ...
                        value = {evaluationData[`${row.label.toLowerCase()}_remarks`]} //evaluationData.rowLabel_remarks
                        onChange={handleChange}
