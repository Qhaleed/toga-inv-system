      ...
      <div className="w-full flex flex-col sm:grid sm:grid-cols-4 h-screen">
        ...
        <div className="flex-1 sm:col-span-3 h-full">
          ...
          >
            ...
            <EvaluationTable isGrid={isGrid} modifyTable={modifyTable} setValue={setValue} setEvaluationTab={setEvaluationTab}/>
          </div>
        </div>
      </div>
    </div>
    <EvaluationTab value={value} evalTab={evalTab} setEvaluationTab={setEvaluationTab}/>
    </>
