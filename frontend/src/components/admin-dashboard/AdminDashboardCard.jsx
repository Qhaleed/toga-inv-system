...
const AdminDashboardCard = () => {
  ...
  return (
    <div className="flex flex-row overflow-hidden h-screen w-screen bg-[#F3F9FF] font-figtree font-medium">
      ...
      <div className="flex-1 max-w-full relative grid grid-cols-1 sm:grid-cols-5 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 2xl:grid-cols-5 sm:gap-0 sm:top-0 sm:left-0 sm:h-screen sm:w-screen">
        {/* Sidebar: full width above on mobile, left on desktop */}
        <div className="w-full sm:col-span-2 relative md:col-span-1 lg:col-span-1 xl:col-span-1 2xl:col-span-1 bg-[#001C47] text-white hidden md:block h-screen">
          <SideBar alwaysShowOnLarge setAdminName={setAdminName} />
        </div>
        {/* Main content: full width on mobile, right of sidebar on desktop */}
        <div className="w-full md:col-span-2 lg:col-span-3 xl:col-span-3 overflow-visible 2xl:col-span-4 sm:col-span-5 col-span-1 h-screen">
