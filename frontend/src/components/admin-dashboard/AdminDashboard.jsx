...
function AdminDashboard() {
  return (
    <div className="grid grid-cols-1 animate-fade-in gap-3 sm:grid-cols-2 lg:grid-cols-3 grid-rows-2 h-[88vh] min-h-[400px]  max-h-[1000px] w-full overflow-x-hidden">
      {/* Row 1 */}
