...
function AdminDashboard({ adminName }) {
  ...
  return (
    <div className="grid grid-cols-1 relative animate-fade-in gap-4 p sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 grid-rows-2 h-full p-5  w-full ">
      {/* Row 1 */}
      <div className=" flex bg-amber-300 pt-10   md:pt-0 md:pl-8 relative h-full ">
      ...
      <div className=" h-full bg-green-300 pt-12 w-full   ">
      ...
      <div className=" flex mt-1  text-xs font-bold  bg-amber-600   h-full col-span-2">
        <div className=" bg-yellow-800 w-full h-fit">
          {" "}
          {/* <GroupBarChart /> */}
        </div>
      </div>
