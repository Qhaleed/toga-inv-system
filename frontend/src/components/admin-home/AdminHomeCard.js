                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li className="border-l-4 border-green-500 pl-3 py-1">Student John D. checked out laptops</li>
                            <li className="border-l-4 border-blue-500 pl-3 py-1">New inventory: 25 USB drives</li>
                            <li className="border-l-4 border-yellow-500 pl-3 py-1">Equipment request for Lab 103</li>
                            <li className="border-l-4 border-red-500 pl-3 py-1">Low stock: Projector bulbs</li>
                        </ul>
                    </div>
                </div>
            </div>
