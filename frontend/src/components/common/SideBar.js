...
const SideBar = () => {
  ...
  return (
    <div className="col-span-1 overflow-hidden flex-wrap h-full flex flex-col justify-start items-center bg-[#001C47]">
      {" "}
        ...
        <div className="w-full">
          ...
          <div className="w-full h-[90px]">
            <div className="w-full h-1/2 flex justify-between items-center">
              <button className="w-[43%] h-7 rounded-md ml-4 flex justify-between items-center bg-gray-300 hover:scale-105 transform-all ease-out duration-300">
                <p className="text-[10px] text-black ml-3">All</p>
                <div className="text-[10px] bg-[#0C7E48] rounded-lg text-white mr-3 px-2">
                  123
                </div>
              </button>
