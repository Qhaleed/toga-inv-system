                            ...
                            <div className="w-11/12 h-60 bg-[#102F5E] flex items-center rounded-xl mt-7">
                                ...
                                <div className="w-full h-[90px]">
                                    <div className="w-full h-1/2 flex justify-between items-center">
                                        <button className="w-[43%] h-7 rounded-md ml-4 flex justify-between items-center bg-[#E9E9E9] hover:scale-105 transform-all ease-out duration-500">
                                            <p className="text-[10px] text-black ml-3">All</p>
                                            <div className="text-[10px] bg-[#0C7E48] rounded-lg text-white mr-3 px-2">123</div>
                                        </button>
                                        <button className="w-[43%] h-7 rounded-md mr-4 flex justify-between items-center bg-[#E9E9E9] transform-all ease-out duration-500 hover:scale-105">
                                            <p className="text-[10px] text-black ml-3">Borrowed</p>
                                            <div className="text-[10px] bg-[#0C7E48] rounded-lg text-white mr-3 px-2">13</div>
                                        </button>
                                    </div>
                                    <div className="w-full h-1/2 flex justify-between items-center">
                                        <button className="w-[43%] h-7 rounded-md ml-4 flex justify-between items-center bg-[#E9E9E9] transform-all ease-out duration-500 hover:scale-105">
                                    ...
                                    <div className="w-full h-[90px]">
                                        <div className="w-full h-1/2 flex justify-between items-center">
                                            <button className="w-[43%] h-7 rounded-md bg-[#E9E9E9] ml-4 flex justify-between items-center hover:scale-105 transform-all ease-out duration-500">
                                                <p className="text-[10px] text-black ml-3">Name</p>
                                                <p className="text-[8px] text-black mr-3">(A - Z)</p>
                                            </button>
                                            <button className="w-[43%] h-7 rounded-md flex justify-between mr-4 items-center bg-[#E9E9E9]  transform-all ease-out duration-500 hover:scale-105">
                                        ...
                                        <div className="w-full h-1/2 flex justify-start items-center pb-2">
                                            <button className="w-[43%] h-7 rounded-md flex justify-between ml-4 items-center bg-[#E9E9E9] transform-all ease-out duration-500 hover:scale-105">
                                                <p className="text-[10px] text-black ml-3">Date</p>
